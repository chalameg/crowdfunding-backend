...
public class AdminCampaignService {
    ...
    public List<Campaign> getCampaigns() {
        List<Campaign> campaigns = campaignRepository.findAll(Sort.by(Sort.Direction.ASC, "id"));
    ...
    public CampaignDTO suspendCampaign(Long campaignId) {
        ...
        campaignUtils.validateCampaignStage(campaign, CampaignStage.FUNDING, "Campaign cannot be suspended unless it is in the funding stage");

        campaign.setCampaignStage(CampaignStage.SUSPENDED);
        campaign.setSuspendedAt(LocalDateTime.now().format(dateTimeFormatter));
    ...
    public CampaignDTO resumeCampaign(Long campaignId) {
        ...
        campaignUtils.validateCampaignStage(campaign, CampaignStage.SUSPENDED, "Campaign cannot be resumed unless it is in the suspended stage");
