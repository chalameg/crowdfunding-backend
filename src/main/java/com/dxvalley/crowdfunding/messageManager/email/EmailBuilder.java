...
public class EmailBuilder {
    public static String emailBuilderForUserConfirmation(String name, String link) {
    ...
    public static String emailBuilderForPasswordReset(String name, String link) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n"
                +
                "\n" +
                "<span style=\"display:none;font-size:1px;color:#fff;max-height:0\"></span>\n" +
                ...
                "                    <td style=\"font-size:28px;line-height:1.315789474;Margin-top:4px;padding-left:10px\">\n"
                +
                "                      <span style=\"font-family:Helvetica,Arial,sans-serif;font-weight:700;color:#ffffff;text-decoration:none;vertical-align:top;display:inline-block\">Please reset your password</span>\n"
                +
                "                    </td>\n" +
                "                  </tr>\n" +
                "                </tbody></table>\n" +
                ...
                "You have requested to reset your password, and this email has been sent to you. " +
                "<p>Please click the button below to finish resetting your password.</p>" +
                ...
                + link
                + "\">Reset Password</a> </p></blockquote>\nThis password reset link is only valid for 30 minutes after you receive this email.\n" +
    ...
    public static String emailBuilderForCollaborationInvitation(String Invitee, String senderName, String campaignTitle, String link) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n"
                +
                "\n" +
                "<span style=\"display:none;font-size:1px;color:#fff;max-height:0\"></span>\n" +
                ...
                + Invitee
                + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">"
                + senderName + " has sent you an invitation to ask for collaboration on the campaign called " + campaignTitle +
                "</p> <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">" +
                "Please click on the below link to view the invitation details and tell us where you stand on collaboration." +
